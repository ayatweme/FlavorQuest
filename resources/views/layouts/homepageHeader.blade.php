                        ...
                        <a href="javascript:void(0);">
                            <svg data-name="feather-icon/facebook" xmlns="http://www.w3.org/2000/svg" width="20"
                                ...
                                <path
                                    ...
                                    transform="translate(5 0.833)" fill="#000000" />
                            </svg>
                        </a>
                        <a href="#0" class="ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20.004" height="20" viewBox="0 0 20.004 20">
                                <g data-name="feather-icon/twitter" transform="translate(0.002)">
                                    ...
                                    <path
                                        ...
                                        transform="translate(-0.002 1.658)" fill="#000000" />
                                </g>
                            </svg>
                        </a>
                        <a href="#0" class="ml-4">
                            <svg data-name="feather-icon/instagram" xmlns="http://www.w3.org/2000/svg" width="20"
                                ...
                                <path
                                    ...
                                    transform="translate(0.833 0.833)" fill="#000000" />
                            </svg>
            ...
            <div class="modal-content rounded-4 shadow-17 mb-4 mb-md-5">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">
                        <svg id="feather-icon_search" data-name="feather-icon/search" xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" viewBox="0 0 24 24">
                            <rect id="Bounding_Box" data-name="Bounding Box" width="24" height="24" fill="#d8d8d8"
                                opacity="0">
                            </rect>
                            <path id="Shape"
    ...
    <div class="container">
        <div class="d-flex align-items-center py-1 py-md-4">
            ...
            <a class="navbar-brand m-auto text-center px-2" href="index.html">
                <img src="assets/images/brands/flavorquest-logo-transparent.svg" alt="FlavorQuest" width="355">
            </a>
            <button class="navbar-toggler pr-0 d-inline-block d-md-none" type="button" data-toggle="collapse"
                data-target="#menu-4" aria-controls="menu-4" aria-expanded="false" aria-label="Toggle navigation">
